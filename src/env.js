...
const environment = {
   ...
   */
  OVERALL_REQUESTS_LIMIT: +process.env.OVERALL_REQUESTS_LIMIT || defaults.OVERALL_REQUESTS_LIMIT,
  OVERALL_REQUESTS_DURATION: +process.env.OVERALL_REQUESTS_DURATION || defaults.OVERALL_REQUESTS_DURATION,
};
